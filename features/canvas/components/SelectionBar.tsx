...
export const SelectionBar: React.FC<SelectionBarProps> = ({ onEdit, onLasso, onZoom, onDelete, onDownload, language }) => {
    ...
    const actionButtons = [
        ...
        { key: 'lasso', onClick: () => onLasso(selectedImage.id), icon: <LassoIcon className="w-5 h-5" />, tooltip: t('tooltip.lassoEdit', language) },
    ];
