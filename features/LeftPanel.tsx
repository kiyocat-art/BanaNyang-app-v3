...
import { GeneratedMedia, GenerationTask, MonthlyCredit } from '../types';
import { t, Language, TranslationKey } from '../localization';
import { Tooltip } from '../components/Tooltip';
import { LoadingSpinner } from '../components/LoadingSpinner';
import { SettingsIcon, FolderIcon, CloseIcon, DownloadIcon, MagnifyIcon, CheckIcon, PencilIcon } from '../components/icons';
                            ...
                            {isProcessing && generationQueue.length > 0 && (
                                <div className="bg-neutral-900/50 p-2 rounded-md flex flex-col gap-2">
                                    ...
                                    <div className="w-full bg-neutral-600 rounded-full h-1.5">
                                        <div className="bg-sky-500 h-1.5 rounded-full progress-bar-inner"></div>
                                    </div>
                                </div>
                            )}
