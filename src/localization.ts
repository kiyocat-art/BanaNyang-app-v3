...
export type TranslationKey =
  ...
  | 'shortcut.alignSelection'
  | 'shortcut.groupSelection'
  | 'shortcut.maskingTool'
  | 'shortcut.saveWorkspace'
  | 'shortcut.saveWorkspaceAs'
  | 'shortcut.loadWorkspace'
  | 'shortcut.deleteSelection'
  | 'shortcut.undoDrawing'
  | 'shortcut.redoDrawing'
  // Color Palette
  | 'colorPalette.title'
  | 'colorPalette.category.mood'
  | 'colorPalette.category.weather'
  | 'colorPalette.category.concept'
  | 'colorPalette.numColors'
  | 'colorPalette.random'
  | 'colorPalette.autoColorizeSketch'
  | 'colorPalette.subCategory.warm'
  | 'colorPalette.subCategory.cool'
  | 'colorPalette.subCategory.vibrant'
  | 'colorPalette.subCategory.pastel'
  | 'colorPalette.subCategory.dark'
  | 'colorPalette.subCategory.monochrome'
  | 'colorPalette.subCategory.sunny'
  | 'colorPalette.subCategory.cloudy'
  | 'colorPalette.subCategory.rainy'
  | 'colorPalette.subCategory.snowy'
  | 'colorPalette.subCategory.nature'
  | 'colorPalette.subCategory.urban'
  | 'colorPalette.subCategory.fantasy'
  | 'colorPalette.subCategory.sciFi'
  ;
...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'tooltip.edit': '이미지 편집',
    'tooltip.painting': '컬러 팔레트',
    'editModal.title': '이미지 편집',
    'maskingModal.title': '마스킹 편집',
    'editModal.cancel': '취소',
    'editModal.apply': '적용',
    ...
    'contextMenu.alignSelection': '이미지 정렬',
    ...
    'contextMenu.copySelection': '이미지 복사',
    ...
    'appSettingsModal.shortcutsDescription': '작업의 단축키를 설정합니다. 변경하려면 버튼을 클릭하고 원하는 키 조합을 누르세요.',
    'appSettingsModal.listening': '키 입력 대기 중...',
    'appSettingsModal.resetDefaults': '기본값으로 재설정',
    'shortcut.alignSelection': '선택 항목 정렬',
    'shortcut.groupSelection': '선택 항목 그룹화',
    'shortcut.maskingTool': '마스킹 도구 열기',
    ...
    'shortcut.undoDrawing': '그리기 실행 취소',
    'shortcut.redoDrawing': '그리기 다시 실행',
    // Color Palette
    'colorPalette.title': '컬러 팔레트',
    ...
    'colorPalette.autoColorizeSketch': '스케치를 자동으로 채색',
    'colorPalette.subCategory.warm': '따뜻한 톤',
    'colorPalette.subCategory.cool': '차가운 톤',
    'colorPalette.subCategory.vibrant': '생동감',
    'colorPalette.subCategory.pastel': '파스텔',
    'colorPalette.subCategory.dark': '어두운 톤',
