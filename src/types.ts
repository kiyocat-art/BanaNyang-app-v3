...
// FIX: Add GenerationParams interface to resolve import error in canvas/index.tsx.
...
export interface GeneratedMedia {
  ...
  // FIX: Add optional generationParams property to store generation settings with the media.
...
// FIX: Added ColorPalette types to resolve circular dependency with constants.ts
...
export interface GenerationTask {
    ...
    maskImage: File | null;
    // FIX: Add color palette properties to fix error in PromptPanel.tsx.
    selectedPalette: ColorPalette | null;
    numPaletteColors: number;
    isAutoColorizeSketch: boolean;
    // FIX: Add numImages property to support multi-image generation requests.
    numImages: number;
}
...
export interface BoardImage {
  ...
  maskFile?: File;
  maskSrc?: string;
  // FIX: Add optional generationParams property to store generation settings with the image.
  generationParams?: GenerationParams;
}
