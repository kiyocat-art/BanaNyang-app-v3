...
export const Header: React.FC<HeaderProps> = ({ onResetAll, onShowAppSettingsModal, language }) => {
    return (
        <header className="h-16 flex-shrink-0 flex items-center justify-between px-6 bg-zinc-900/50 backdrop-blur-xl border-b border-white/10">
            ...
            <div className="flex items-center gap-2">
                <Tooltip tip={t('tooltip.header.manageAppSettings', language)} position="bottom">
                    <button onClick={onShowAppSettingsModal} className="p-2 text-zinc-400 hover:text-white transition-colors">
